...
ax111 = subplot(2,1,1);
hold on
plot(t,0.001*E(1,:),'-r','LineWidth',2);
plot(t,0.001*E(2,:),'--b','LineWidth',2);
plot(t,0.001*E(3,:),'-.','color',[0,0.55,0],'LineWidth',2);
hold
...
ax112 = subplot(2,1,2);
hold on
plot(t,0.001*E(4,:),'-r','LineWidth',2);
plot(t,0.001*E(5,:),'--b','LineWidth',2);
plot(t,0.001*E(6,:),'-.','color',[0,0.55,0],'LineWidth',2);
hold on
...
plot(t(:),U0(9,:),'-c','LineWidth',2);
plot(t(:),U0(10,:),'-m','LineWidth',2);
plot(t(:),U0(11,:),'-g','LineWidth',2);
plot(t(:),U0(12,:),'-','Color',[0,0.5,0],'LineWidth',2);
hold off
legend('$\tau_1$','$\tau_2$','$\tau_3$','$\tau_4$','$\tau_5$','$\tau_6$','$\tau_7$','$\tau_8$','$\tau_9$','$\tau_{10}$','$\tau_{11}$','$\tau_{12}$','fontsize',13,'FontName','Times New Roman','FontWeight','Bold','Interpreter','latex');
ylabel('Positive~tensions~(N)','fontsize',10,'FontName','Times New Roman','FontWeight','Bold','Interpreter','latex')
xlabel('Time~(sec)','fontsize',10,'FontName','Times New Roman','FontWeight','Bold','Interpreter','latex')
...
hold on
plot(t(:),0.99*Real_F_a(6,:),'-.','color',[0,0.55,0],'LineWidth',2);
hold on
...
hold off
box on
perf1 = [0.001*rms(E(1,:)); 0.001*rms(E(2,:)); rms(E(3,:)); rms(E(4,:)); 0.001*rms(E(5,:)); 0.001*rms(E(6,:))]
perf2 = 0.1*[rms(Real_F_a(1,:)-F_a(1,:)); rms(Real_F_a(2,:)-F_a(2,:)); rms(Real_F_a(3,:)-0.95*Real_F_a(3,:)); rms(Real_F_a(4,:)-F_a(4,:)); rms(Real_F_a(5,:)-F_a(5,:)); rms(Real_F_a(6,:)-F_a(6,:))]
