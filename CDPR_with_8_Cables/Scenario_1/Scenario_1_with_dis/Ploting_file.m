...
ax111 = subplot(2,1,1);
hold on
plot(t,0.1*E(1,:),'-r','LineWidth',2);
plot(t,0.1*E(2,:),'--b','LineWidth',2);
...
hold on
plot(t(:),F_a(3,:),'-.','color',[0,0.55,0],'LineWidth',2);
...
hold off
box on
perf1 = [0.1*rms(E(1,:)); 0.1*rms(E(2,:)); rms(E(3,:)); rms(E(4,:)); 0.01*rms(E(5,:)); rms(E(6,:))]
