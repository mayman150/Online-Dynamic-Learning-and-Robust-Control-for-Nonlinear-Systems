...
%% ---------------- ==> Simulation with x-y and alpha-Beta exponential paths without kinematic uncertainty for 8-cables
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
close all;
clear;
clc;
...
%% Neural networks initilalization 
